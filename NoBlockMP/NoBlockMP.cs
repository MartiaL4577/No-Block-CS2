...
public class NoBlockMP : BasePlugin
{
    // The retrievable information about the plugin itself
    public override string ModuleName => "[Custom] No Block CS2";
    ...
    public override string ModuleVersion => "Version: counterstrikesharp.api 1.0.235 [Beta]";
